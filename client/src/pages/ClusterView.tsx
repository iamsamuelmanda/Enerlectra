...
import ContributeForm from '../features/contributions/components/ContributionForm'; // ← default import (after you add export default)
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center gap-2 mt-2 text-purple-200">
          ...
          <span>
            {cluster.location?.district}, {cluster.location?.province}
          </span>
        </div>
      </div>
